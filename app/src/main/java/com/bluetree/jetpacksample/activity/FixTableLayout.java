...
public class FixTableLayout extends FrameLayout {
    ...
    private void init() {
        //活动布局
        HorizontalScrollView horizontalScrollerView = new HorizontalScrollView(getContext());
        ...
        horizontalScrollerView.setHorizontalScrollBarEnabled(false);
         ...
         rvActive = new RecyclerView(getContext());
    ...
    public abstract static class CombineAdapter<T,F extends RecyclerView.ViewHolder,A extends RecyclerView.ViewHolder>{
        ...
        abstract void onFixBindViewHolder(@NonNull F vh, int i);
        abstract void onActiveBindViewHolder(@NonNull A vh, int i);
        abstract View getFixView(ViewGroup viewGroup);
        abstract View getMoveView(ViewGroup viewGroup);
        abstract int getFixColumnWidth();
